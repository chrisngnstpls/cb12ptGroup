...
module.exports = function BadCombo(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.BadCombo()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.BadCombo()` called with an Error:', optionalData);
